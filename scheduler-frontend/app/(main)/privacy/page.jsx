...
const Privacy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Scheduler.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Scheduler, accessible from{" "}
            <a
              href="https://scheduler-34xve2v7z-rohit8008s-projects.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://scheduler-34xve2v7z-rohit8008s-projects.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mittalrohit701@gmail.com</li>
      </ul>
    </div>
  );
};
